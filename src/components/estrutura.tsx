        ...
        return (
            ...
            >
                <Box justifyContent="center"
                    alignItems="center" justifyItems="center" alignContent="center"
                    display="flex" mb="3%" textAlign="center"
                ...
                >
                    ...
                    <Text color="white"
                        ...
                        fontSize="1.2rem" w={['auto', 'auto', 'auto', "40%"]} lineHeight="25px" mt="1%">
                    Todos os participantes terão a oportunidade
de conhecer a estrutura física do SERAC.
                    </Text>
                </Box>
                <Gallery>
                    <SimpleGrid
